...
AI/RAG chat engine, and the architecture/dependency explorer are complete
and tested: email/password auth, GitHub OAuth login, organizations with
role-based authorization (owner/admin/developer/viewer), password reset,
email verification, a GitHub App connection flow, a repository overview
...
highlighting and clickable citations, source panel) — and an
...
commits, and progressive package → module expansion) — all backed by a
real database and 124 passing backend tests. See
...
for the AI/RAG chat engine, and
